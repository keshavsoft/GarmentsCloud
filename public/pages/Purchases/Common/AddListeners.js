...
let StartFunc = () => {
    ...
    let jVarLocalQrCodeGenerateId = document.getElementsByClassName("QrCodeGenerateId");

    jVarLocalQrCodeGenerateId.addEventListener("click", LocalPostQrCodeButtonFuncs)

};

let LocalPostQrCodeButtonFuncs =  () => {
    let localReturnRowPK = ReturnRowPK().RowPK
